...
export default function ClientSeed() {
            ...
            <div className=" w-full max-w-2xl mx-auto p-4 py-12">
                ...
                <div className="bg-neutral-800 rounded-xl p-6 border border-neutral-700/30 mb-8">
                    ...
                    <div className="mt-4 flex justify-between">
                        <button onClick={() => { copyToClipboard(seedPhrase) }} className="flex items-center text-indigo-400 hover:text-indigo-300 transition-colors">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        {copySuccess && (
                            <p className="text-sm text-green-400 font-semibold mt-1">{copySuccess}</p>
                        )}
