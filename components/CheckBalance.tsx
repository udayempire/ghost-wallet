...
export const CheckBalance = () => {
    ...
    return (
        <div>
            <h1 className=" w-4xl text-zinc-300 font-semibold text-5xl text-center">Check your <span className="text-purple-500">{formatedNetwork}</span> Wallet Balance</h1>
            <div className="mt-20 flex flex-col gap-5">
                ...
                {response !=="" && (
                <div className="mt-8 p-4 bg-zinc-200 rounded-sm font-medium text-xl">
